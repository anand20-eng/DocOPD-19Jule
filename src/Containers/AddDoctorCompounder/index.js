...
const AddDoctorCompounder = ({ navigation, theme }) => {
	...
	return (
		<KeyboardAwareScrollView style={styles.container}>
			...
			{roleValue == 'doctor' ? null : <View style={{ marginBottom: 10 }}>
				<DropdownComp
					Open={genderOpen}
					Value={genderValue}
					allItems={gender}
			...
			<View style={{ marginTop: 20 }}>
				<ButtonComponent onPress={AddDoctorCompounder}
					title='Register' />
			</View>
...
// export default withTheme(AddDoctorCompounder);
export default AddDoctorCompounder;